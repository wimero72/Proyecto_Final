...
urlpatterns = [
    ...
    path('headhunter/agenda/', views.agenda, name='agenda'), # Renombrada a 'agenda'
    path('headhunter/api/acciones/', views.api_acciones_headhunter, name='api_acciones_headhunter'),
    path('headhunter/crear-accion-ajax/', views.crear_accion_ajax, name='crear_accion_ajax'), # Añadido -ajax para claridad
    path('headhunter/agenda/editar-accion-ajax/<int:pk>/', views.editar_accion_ajax, name='editar_accion_ajax'), # Añadido
    path('headhunter/agenda/eliminar-accion-ajax/<int:pk>/', views.eliminar_accion_ajax, name='eliminar_accion_ajax'), # Añadido
