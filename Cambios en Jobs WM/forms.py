...
from .models import JobOffer, User, Candidatura, StatusMessageTemplate, CANDIDATURE_STATUS_CHOICES, AgendaAccion
...
class AgendaAccionForm(forms.ModelForm):
    class Meta:
        model = AgendaAccion
        fields = ['oferta', 'titulo', 'descripcion', 'fecha', 'hora', 'tipo']
